...
#' @param show_legend Boolean; determines whether a legend should be included in the plot.
#'
...
pathways.visual.parameters.segments <- function(
  ...
  g <- ggplot(data = stats, aes(x = segment, y = expression, group = path, color = path)) +
