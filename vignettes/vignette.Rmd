...
Single-cell cytometric and transcriptomic data provide a snapshot of cellular marker expression in cells from experimental subjects, healthy human donors and patients alike. Some of these data are representative of multiple consecutive stages in the development of a cell population, *e.g.* of B lymphocytes in bone marrow or of T lymphocytes in the thymus. Cell types and cell states comprising known developmental pathways can be detected and described using computational tools from the realm of trajectory inference (TI). We present a novel TI tool for semi-supervised discovery of developmental pathways called `tviblindi`.
